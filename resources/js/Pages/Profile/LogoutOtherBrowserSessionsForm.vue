    ...
    <jet-action-section>
        ...
        <template #content>
                    ...
                    <div class="ml-3">
                        ...
                        <div>
                            <div class="text-xs text-gray-500">
                                ...
                                <span class="text-green-500 font-semibold" v-if="session.is_current_device">Este equipamento</span>
                                <span v-else>Último ativo {{ session.last_active }}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <jet-dialog-modal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    Por favor, digite sua senha para confirmar que você gostaria de sair de suas outras sessões do navegador em todos os seus dispositivos.
